...
#   }
	...
	def save_pose_perception_json(self):
		if not os.path.exists("/home/lsm/SFTSG_NME/src/approach/RQ/RQ1/fuar_genetic_runtime_data"):
			os.makedirs("/home/lsm/SFTSG_NME/src/approach/RQ/RQ1/fuar_genetic_runtime_data")
			with self.lock:
				with open(fr"/home/lsm/SFTSG_NME/src/approach/RQ/RQ1/fuar_genetic_runtime_data/{self.name}_scenario.json", 'a') as f:
