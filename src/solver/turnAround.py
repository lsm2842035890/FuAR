...
def solveTurnAround(end, laneAndDirection, laneCount, width, intersection):
    ...
    if direction == 3:
        if intersection == "yes":
            positionExp = [w5X == endX] + \
                          ...
                          [w2Y < w1Y] + \
                          [w3Y < w2Y] + \
                          [w3Y == 2 * laneCount * width] + \
                          [w4Y > w3Y] + \
                          [w5Y > w4Y] + \
                          [w1Y == 2 * laneCount * width + width] + \
                          [w2Y - w1Y - (w3Y - w1Y) * (w2X - w1X) / (w3X - w1X) < 0] + \
                          [w4Y - w3Y - (w5Y - w3Y) * (w4X - w3X) / (w5X - w3X) < 0]
        else:
            positionExp = [w5X == endX] + \
    ...
    if direction == 4:
        if intersection == "yes":
            positionExp = [w5X == endX] + \
                          [w2X < w1X] + \
                          [w3X < w2X] + \
                          [w3X == 2 * laneCount * width] + \
                          [w4X > w3X] + \
                          [w5X > w4X] + \
                          [w1X == 2 * laneCount * width + width] + \
                          [w5Y == endY] + \
                          [w2Y < w1Y] + \
                          [w3Y < w2Y] + \
                          [w3Y == laneCount * width] + \
