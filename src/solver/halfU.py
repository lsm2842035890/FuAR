...
def solveHalfU(end, laneAndDirection, laneCount, width, intersection):
    ...
    if direction == 1:
        if intersection == "no":
            ...
            positionExp = [w5X == endX] + \
                          ...
                          [w4X < w3X] + \
                          [w5X < w4X] + \
                          [w1X > (laneCount + lane - 1) * width + 1] + \
                          [w1X < (laneCount + lane) * width - 1] + \
                          [w5Y == endY] + \
                          [w2Y > w1Y] + \
                          [w3Y > w2Y] + \
                          [w4Y > w3Y] + \
